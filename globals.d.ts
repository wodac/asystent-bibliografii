...
function GM_getValue<K extends keyof StoredValueType> (name: K, defaultValue?: StoredValueType[K]): StoredValueType[K] 
...
function GM_setValue<K extends keyof StoredValueType> (name: K, value: StoredValueType[K]): any
